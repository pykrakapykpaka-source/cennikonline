  ...
  return (
    <div
      className={`${
        ...
        !pathname.includes("zamow-cennik") &&
        ...
        >
          <div className="bg-gradient-to-br from-[#C5FF17] to-[#33E5CF] p-6 flex flex-col sm:flex-row xl:sticky z-10 top-0 left-0">
            <div className="w-max flex items-center justify-center pr-12">
              <div className="font-extrabold tracking-tight text-2xl lg:text-3xl">
                <span className="text-zinc-900">Cennik</span>
                <span className="text-zinc-900/80">Online</span>
              </div>
            </div>
            <div className="lg:px-3 mt-3 lg:mt-0">
              ...
              <p className="sm:text-justify mt-3 mx-auto text-gray-600 font-light">
                Dzięki podanym informacjom przygotujemy cennik dopasowany do
                Twojej branży, zakresu usług i sposobu sprzedaży.
              </p>
            </div>
          </div>
          <div className="w-full text-zinc-800">
            <ClientFormLogic
              ...
              questionsPaddingX="px-4 sm:px-6"
            />
          </div>
        </div>
      </div>
