...
import { pushAssistantMessage, pushQuestion } from "@/common/firebase";
...
export async function GET(req: NextRequest) {
  ...
  if (mode === "lawyer") {
    ...
    await chat.sendMessage("Ping");
    const response = await chat.sendMessage(
      `Jesteś asystentem sprzedaży firmy, która sprzedaje cenniki online dla firm. Pomagasz w doborze najlepszego układu cennika, opisu usług, pakietów oraz w uporządkowaniu wyceny usług (ogólnie, bez odpowiedzialności i bez gwarancji konkretnych wyników).
